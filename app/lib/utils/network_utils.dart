...
class NetworkUtils {
  ...
  static const List<String> commonHosts = [
    'http://127.0.0.1:8000', // Try this first
    'http://localhost:8000',
    'http://192.168.1.149:8000', // Your actual IP
    'http://10.0.2.2:8000', // Android emulator
    'http://192.168.1.100:8000', // Common local network
    'http://192.168.0.100:8000', // Common local network
    'http://192.168.2.29:8000', // Original host
  ];
